...
class OlInfoServiceImplTest {
    ...
    void delInfoById004() {
        Mockito.when(olInfoMapper.delInfoById(Mockito.anyInt())).thenReturn(1);
        Mockito.when(olInfo2UserMapper.delInfoById(Mockito.anyInt())).thenReturn(null);
    ...
    void delInfoById005() {
        Mockito.when(olInfoMapper.delInfoById(Mockito.anyInt())).thenReturn(1);
        Mockito.when(olInfo2UserMapper.delInfoById(Mockito.anyInt())).thenReturn(0);
    ...
    void delInfoById006() {
        Mockito.when(olInfoMapper.delInfoById(Mockito.anyInt())).thenReturn(1);
        Mockito.when(olInfo2UserMapper.delInfoById(Mockito.anyInt())).thenReturn(1);
